package app.test.migrator.matching.matching_server_util;
...
public class SendJson {
    ...
    public static void send(JSONArray jsonObject) {
    ...
    public static void toJson(List<Pair<Event, List<Double>>> eventList) {
